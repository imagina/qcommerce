...
export default {
  ...
  computed: {
    crudData() {
      return {
        crudId: this.crudId,
        entityName: config("main.qcommerce.entityNames.volumeClasses"),
        apiRoute: 'apiRoutes.qcommerce.volumeClasses',
        permission: 'icommerce.volumeclasses',
        create: {
          title: this.$tr('icommerce.cms.sidebar.newVolumeClasses'),
        },
        computed: {
          isValid() {
        ...
        update: {
          title: this.$tr('icommerce.cms.sidebar.updateVolumeClasses'),
          requestParams: {}
        },
        delete: true,
        //Form
